...
/**
 * Performance test for the JobHistory entity.
 */
class JobHistoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the JobHistory entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all jobHistories")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created jobHistory")
                .get("${new_jobHistory_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created jobHistory")
            .delete("${new_jobHistory_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
