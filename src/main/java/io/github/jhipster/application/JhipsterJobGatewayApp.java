...
@EnableZuulProxy
public class JhipsterJobGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterJobGatewayApp.class);

    private final Environment env;

    public JhipsterJobGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterJobGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterJobGatewayApp.class);
